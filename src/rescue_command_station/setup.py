...
setup(
    ...
    package_data={package_name: ['arm/web_assets/*.html', 'arm/web_assets/*.js']},
    install_requires=['setuptools', 'numpy', 'PyYAML'],
    extras_require={'canvas': ['playwright>=1.40,<2']},
    zip_safe=False,
    ...
    entry_points={
        'console_scripts': [
            ...
            'arm_canvas_preview = rescue_command_station.arm.web_view:main',
            'arm_simulator = rescue_command_station.arm.simulator:main',
        ],
    },
)
